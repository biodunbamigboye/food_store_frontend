        ...
        <!-- total sales card -->
            ...
            <div class="card">
              <div class="grid-item-1">
                <div class="grid-item-1-start-start">
                  ...
                  <h2 class="heading-level-6 u-margin-block-start-8"><span></span>10</h2>
                </div>
                <!-- <div class="grid-item-1-start-end">
                    <div class="status">
                      <button class="tag">
          ...
          <li>
            <div class="card">
              <div class="grid-item-1">
                <div class="grid-item-1-start-start">
                  <div class="eyebrow-heading-3">Product Cycle</div>
                  <h2 class="heading-level-6 u-margin-block-start-8"><span></span>10</h2>
                </div>
                <!-- <div class="grid-item-1-start-end">
                    <div class="status">
          ...
          <li>
            <div class="card">
              <div class="grid-item-1">
                <div class="grid-item-1-start-start">
                  <div class="eyebrow-heading-3">Users</div>
                </div>
              </div>
              <div>
                  <h2 class="heading-level-1 u-margin-block-start-8"><span></span>10</h2>
                </div>
            </div>
          </li>
          <!-- new sales card -->
          <li>
            <div class="card">
              <div class="grid-item-1">
                <div class="grid-item-1-start-start">
                  <div class="eyebrow-heading-3">New Sales</div>
                  <h2 class="heading-level-6 u-margin-block-start-8"><span></span>10</h2>
                </div>
                <!-- <div class="grid-item-1-start-end">
                    <div class="status">
